...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="身份证号" name="fIdcard" type="String" xid="xid3"></column></div></div>  
  ...
  <input component="$UI/system/components/justep/input/input" class="form-control" xid="input3" placeHolder="请输入您的身份证号"></input>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-block" label="绑  定" xid="button1" style="margin-top:15px;">
   <i xid="i1"></i>
