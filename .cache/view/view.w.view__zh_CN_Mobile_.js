...
var __result = __parent1._extend(__parent0).extend({
 ...
 var __BaasData__ = require("$UI/system/components/justep/data/baasData");new __BaasData__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"contact":{"define":"contact","label":"contact","name":"contact","relation":"contact","type":"String"},"id":{"define":"id","label":"id","name":"id","relation":"id","rules":{"integer":true},"type":"Integer"},"text":{"define":"text","label":"text","name":"text","relation":"text","type":"String"}},"directDelete":false,"events":{},"limit":20,"queryAction":"queryForm","saveAction":"saveForm","tableName":"form","url":"/app/app","xid":"viewData"});
}}); 
return __result;});
