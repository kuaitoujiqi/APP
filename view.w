...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:321px;top:462px;"><div component="$UI/system/components/justep/data/data" autoLoad="false" xid="userData" idColumn="text" autoNew="true">
   <column label="Sarea" name="text" type="String" xid="default4"></column>
  <column label="Sbrand" name="contact" type="String" xid="default5"></column></div></div> 
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;">
  ...
  <textarea component="$UI/system/components/justep/textarea/textarea" xid="suggestTextarea" placeHolder="请留下您的宝贵意见，我们的客服人员将第一时间给您反馈。" class="form-control" style="height:200px;" bind-ref='$model.userData.ref("text")'></textarea>
  <input component="$UI/system/components/justep/input/input" class="form-control" xid="emailInput" placeHolder="请留下您的联系方式，QQ/手机号/邮箱等" bind-ref='$model.userData.ref("contact")'></input></div>
