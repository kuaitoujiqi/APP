...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;">
   ...
   <div class="x-panel-content" xid="content1" style="background-color:#F4F2FF;"><div xid="div1"></div>
...
<input component="$UI/system/components/justep/input/input" class="form-control" xid="emailInput" placeHolder="请留下您的联系方式，QQ/手机号/邮箱等"></input>
