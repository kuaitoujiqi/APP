  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="还款记录"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">还款记录</div>  
     ...
     <li xid="li1">
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
       ...
       <div class="x-col" xid="col5" style="text-align:center;">
        <span xid="span7" bind-text='ref("fTime")' style="font-size:20px;background-color:#FFFFFF;color:#487BEE;"></span></div> </div> 
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
       <div class="x-col" xid="col7" style="text-align:center;">
        <span xid="span9">还款金额</span></div> 
       <div class="x-col" xid="col8" style="text-align:center;">
        <span xid="span10">投资日期</span></div> </div> </li> </ul> </div> </div></div>
  </div> 
</div>